...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from bill where ostatus='Delivered' and cuname=?");
	ps.setString(1,un);
	ResultSet rs=ps.executeQuery();
	

%>
<h3 class="text-success text-center mb-4">You will get all the details of Past Orders here </h3>
...
<%
	while(rs.next())
	{
		...
		%><a target=_blank href=viewcustorder.jsp?billno=<%=rs.getString(1)%>&uname=<%=rs.getString(6)%> class="btn btn-warning">Get Order Details</a></td></tr>
